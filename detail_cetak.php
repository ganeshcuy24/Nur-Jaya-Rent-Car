		...
		<div class="container-fluid">
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td class="text-center"><h2>Nur Jaya Rent Car</h2></td>
					</tr>
					<tr>
						<td class="text-center">Jl.
Lamongan Barat IX, Sampangan, Kecamatan Gajahmungkur, Kota Semarang.  </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
			...
			<table class="table table-borderless">
				<tbody>
					...
					<?php
						...
						<tr>
							<td colspan='3'>
								<b>(Silahkan transfer total biaya sewa ke Rekening)<label>14547789-Bank Bri/Nur Puji Susanto</label>
			<b>maksimal Sebelum Tanggal Yang Di Sewa <?php echo IndonesiaTgl($tglhasil);?>.
							</td>
						</tr>
							";
						}else{
