...
$jmlhari = 1; // Ganti dengan jumlah hari yang diinginkan
$tglselesai = strtotime("+" . $jmlhari . " day", $tglmulai);

$now = date("Y-m-d", $tglselesai);

echo "Tanggal Mulai: " . date("Y-m-d", $tglmulai) . "<br>";
echo "Tanggal Selesai: " . date("Y-m-d", $tglselesai) . "<br>";
echo "Durasi: " . $jmlhari . " hari";
...
function valid()
{
	if(document.sewa.todate.value < document.sewa.fromdate.value){
		alert("Tanggal selesai harus lebih kecil dari tanggal mulai sewa!");
		return false;
	}
